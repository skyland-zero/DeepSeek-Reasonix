...
before it can be safe, call ask and let the answer shape the plan. If no
answer is available, proceed with a sensible default and state the assumption,
or note the choice and stop for the user.
