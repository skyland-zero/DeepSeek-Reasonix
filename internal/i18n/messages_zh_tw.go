...
var ChineseTraditional = Messages{
	...
	ChatThinking:                           "思考中…",
	ChatThinkingLiveFmt:                    "%s %s · %.1f 秒",
	ChatThoughtForFmt:                      "思考了 %d 秒",
	ChatStatusThinkingFmt:                  "%s 思考中… (%.1f 秒 · Esc 取消)",
	ChatToolWorkingFmt:                     "%s 執行中 · %.1f 秒",
	...
	ChatStatusCancellingFmt:                "%s 正在停止… (%.1f 秒 · Ctrl+C 退出)",
	ChatStatusIdle:                         "就緒",
	...
	PlanModeToggleBusy:                     "模式切換在回合結束後生效——請等待目前回合完成",
	...
	CmdModel:            "切換模型",
	CmdStatus:           "顯示工作階段狀態",
	CmdQuota:            "查看 OpenCode Go 套餐額度",
	QuotaSetupDone:      "OpenCode Go 憑證已儲存",
	QuotaSetupFailed:    "憑證儲存失敗",
	QuotaLogoutDone:     "OpenCode Go 憑證已清除",
	QuotaLogoutFailed:   "清除憑證失敗",
	CmdWorkMode:         "切換工作模式",
