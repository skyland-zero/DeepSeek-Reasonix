...
var English = Messages{
	...
	Subtitle:            "build your code castle in the sky",
	...
	ChatThinkingLiveFmt:                    "%s %s · %.1fs",
	ChatThoughtForFmt:                      "thought for %ds",
	ChatStatusThinkingFmt:                  "%s thinking… (%.1fs · Esc cancels)",
	ChatToolWorkingFmt:                     "%s working · %.1fs",
	...
	ChatStatusCancellingFmt:                "%s stopping… (%.1fs · Ctrl+C exits)",
	...
	PlanModeToggleBusy:                     "mode switches take effect between turns — wait for the current turn to finish",
	...
	CmdQuota:            "show OpenCode Go quota",
	QuotaSetupDone:      "OpenCode Go credentials stored",
	QuotaSetupFailed:    "quota setup failed",
	QuotaLogoutDone:     "OpenCode Go credentials cleared",
	QuotaLogoutFailed:   "quota logout failed",
