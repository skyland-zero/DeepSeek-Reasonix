...
var Chinese = Messages{
	...
	PlanModeToggleBusy:                     "模式切换在回合结束后生效——请等待当前回合完成",
	...
	CmdModel:            "切换模型",
	CmdStatus:           "显示会话状态",
	CmdQuota:            "查看 OpenCode Go 套餐额度",
	QuotaSetupDone:      "OpenCode Go 凭证已保存",
	QuotaSetupFailed:    "凭证保存失败",
	QuotaLogoutDone:     "OpenCode Go 凭证已清除",
	QuotaLogoutFailed:   "清除凭证失败",
	CmdWorkMode:         "切换工作模式",
