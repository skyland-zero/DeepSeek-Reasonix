...
命名配色，再用 `/theme <style>` 选择。强调色风格只染色当前模式的基础调色板；完整调色板
主题（dracula、gruvbox-*、catppuccin-*、nord、solarized-*、onedark、monokai、
base16-snazzy、tokyonight-*、rose-pine-*、kanagawa-wave、github）会重染整个界面，
代码和 diff 高亮也会跟随当前主题。
